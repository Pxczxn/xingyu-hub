...
export const operLogApi = {
  page(params: { page: number; pageSize: number; title?: string; operName?: string; status?: number }): Promise<PageResult<SysOperLog>> {
    return apiPage<SysOperLog>({ url: '/monitor/operlog/page', method: 'get', params })
  },
...
export const loginLogApi = {
  page(params: { page: number; pageSize: number; username?: string; status?: number }): Promise<PageResult<SysLoginLog>> {
    return apiPage<SysLoginLog>({ url: '/monitor/loginlog/page', method: 'get', params })
  },
  delete(id: number): Promise<void> {
...
export const onlineApi = {
  list(): Promise<OnlineUser[]> {
    return apiList<OnlineUser>({ url: '/monitor/online/list', method: 'get' })
  },
...
export const jobApi = {
  page(params: { page: number; pageSize: number; jobName?: string; jobGroup?: string; status?: number }): Promise<PageResult<SysJob>> {
    return apiPage<SysJob>({ url: '/monitor/job/page', method: 'get', params })
  },
  detail(id: number): Promise<SysJob> {
    return apiRecord<SysJob>({ url: `/monitor/job/${id}`, method: 'get' })
  },
  ...
  logPage(params: { page: number; pageSize: number; jobName?: string; jobGroup?: string; status?: number }): Promise<PageResult<SysJobLog>> {
    return apiPage<SysJobLog>({ url: '/monitor/job/log/page', method: 'get', params })
  },
  logStatistics(): Promise<{ totalCount: number; successCount: number; failCount: number; dailyStats: Array<{ exec_date: string; success_count: number; fail_count: number }> }> {
    return apiRecord({ url: '/monitor/job/log/statistics', method: 'get' })
  },
...
export const cacheApi = {
  info(): Promise<Record<string, unknown>> {
    return apiRecord({ url: '/monitor/cache/info', method: 'get' })
  },
  stats(): Promise<CacheStats> {
    return apiRecord<CacheStats>({ url: '/monitor/cache/stats', method: 'get' })
  },
  keys(pattern?: string): Promise<string[]> {
    return apiList<string>({ url: '/monitor/cache/keys', method: 'get', params: { pattern } })
  },
  delete(key: string): Promise<void> {
    return request({ url: '/monitor/cache', method: 'delete', params: { key } })
  },
  getValue(key: string): Promise<unknown> {
    return apiValue({ url: '/monitor/cache/value', method: 'get', params: { key } })
  }
}
...
export const serverApi = {
  info(): Promise<Record<string, unknown>> {
    return apiRecord({ url: '/monitor/server/info', method: 'get' })
  }
}
...
export const apiAccessApi = {
  page(params: {
    ...
    return apiPage<ApiAccessLog>({ url: '/monitor/api-access/page', method: 'get', params })
  },
  statistics(params?: { startDate?: string; endDate?: string }): Promise<ApiAccessStatistics> {
    return apiRecord<ApiAccessStatistics>({ url: '/monitor/api-access/statistics', method: 'get', params })
  }
}
