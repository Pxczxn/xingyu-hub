...
export const dashboardApi = {
  getStats(): Promise<DashboardStats> {
    return apiRecord<DashboardStats>({ url: '/dashboard/stats', method: 'get' })
  }
}
...
export const userApi = {
  page(params: {
    ...
    return apiPage<SysUser>({ url: '/sys/user/page', method: 'get', params })
  },
  
  detail(id: number): Promise<UserDetailResult> {
    return apiRecord<UserDetailResult>({ url: `/sys/user/${id}`, method: 'get' })
  },
  ...
  importUsers(file: File): Promise<{ success: number; fail: number; errors: string[] }> {
    ...
    }).then((data) => asApiRecord<{ success: number; fail: number; errors: string[] }>(data))
  },
...
export const postApi = {
  ...
  tree(): Promise<SysPost[]> {
    return apiList<SysPost>({ url: '/sys/post/tree', method: 'get' })
  },
...
export const roleApi = {
  page(params: { page: number; pageSize: number; name?: string; status?: number }): Promise<PageResult<SysRole>> {
    return apiPage<SysRole>({ url: '/sys/role/page', method: 'get', params })
  },
  
  list(): Promise<SysRole[]> {
    return apiList<SysRole>({ url: '/sys/role/list', method: 'get' })
  },
  
  detail(id: number): Promise<RoleDetailResult> {
    return apiRecord<RoleDetailResult>({ url: `/sys/role/${id}`, method: 'get' })
  },
...
export const deptApi = {
  tree(): Promise<SysDept[]> {
    return apiList<SysDept>({ url: '/sys/dept/tree', method: 'get' })
  },
...
export const menuApi = {
  tree(params?: { name?: string; status?: number }): Promise<SysMenu[]> {
    return apiList<SysMenu>({ url: '/sys/menu/tree', method: 'get', params })
  },
  
  list(): Promise<SysMenu[]> {
    return apiList<SysMenu>({ url: '/sys/menu/list', method: 'get' })
  },
  
  detail(id: number): Promise<SysMenu> {
    return apiRecord<SysMenu>({ url: `/sys/menu/${id}`, method: 'get' })
  },
...
export const fileGroupApi = {
  list(): Promise<FileGroupListResult> {
    return apiRecord<FileGroupListResult>({ url: '/sys/file-group/list', method: 'get' })
  },

  detail(id: number): Promise<SysFileGroup> {
    return apiRecord<SysFileGroup>({ url: `/sys/file-group/${id}`, method: 'get' })
  },
...
export const fileApi = {
  page(params: { page: number; pageSize: number; originalName?: string; fileType?: string }): Promise<PageResult<SysFile>> {
    return apiPage<SysFile>({ url: '/sys/file/page', method: 'get', params })
  },
  ...
  pageByGroup(params: { 
    ...
    return apiPage<SysFile>({ url: '/sys/file/page-by-group', method: 'get', params })
  },
  
  detail(id: number): Promise<SysFile> {
    return apiRecord<SysFile>({ url: `/sys/file/${id}`, method: 'get' })
  },
  ...
  upload(file: File, path?: string, groupId?: number | null): Promise<SysFile> {
    ...
    return request({
      ...
      data: formData,
      headers: { 'Content-Type': 'multipart/form-data' }
    }).then((data) => asApiRecord<SysFile>(data))
  },
  ...
  getDownloadUrl(id: number): string {
    return `/api/v1/admin/sys/file/download/${id}`
  },
  
  getPreviewUrl(id: number): string {
    return `/api/v1/admin/sys/file/preview/${id}`
  },

  getTextContent(id: number): Promise<string> {
    return apiValue<string>({ url: `/sys/file/text/${id}`, method: 'get' })
  },
...
export const fileConfigApi = {
  page(params: { page: number; pageSize: number; name?: string; storageType?: string }): Promise<PageResult<SysFileConfig>> {
    return apiPage<SysFileConfig>({ url: '/sys/file-config/page', method: 'get', params })
  },
  
  list(): Promise<SysFileConfig[]> {
    return apiList<SysFileConfig>({ url: '/sys/file-config/list', method: 'get' })
  },
  
  detail(id: number): Promise<SysFileConfig> {
    return apiRecord<SysFileConfig>({ url: `/sys/file-config/${id}`, method: 'get' })
  },
  
  getMaster(): Promise<SysFileConfig> {
    return apiRecord<SysFileConfig>({ url: '/sys/file-config/master', method: 'get' })
  },
  ...
  testConfig(data: SysFileConfig): Promise<boolean> {
    return apiValue<boolean>({ url: '/sys/file-config/test', method: 'post', data })
  }
}
