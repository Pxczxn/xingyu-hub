<template>
  <div class="system-workspace page-container">
    <header class="admin-page-heading">
      <div><p class="admin-page-heading__kicker">SIGN-IN AUDIT</p><h1>登录日志</h1><span class="admin-page-heading__description">查看后台账号的登录结果、来源和设备信息。</span></div>
    </header>
...
const columns: DataTableColumns<SysLoginLog> = [
  ...
  { title: 'IP地址', key: 'ipaddr', ...colLayout('slug') },
