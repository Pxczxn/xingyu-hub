<template>
  <div class="system-workspace page-container">
    <header class="admin-page-heading">
      <div><p class="admin-page-heading__kicker">AUDIT TRAIL</p><h1>操作日志</h1><span class="admin-page-heading__description">追踪后台操作、请求结果与异常信息。</span></div>
    </header>
...
const columns: DataTableColumns<SysOperLog> = [
  ...
  { title: '模块名称', key: 'title', ...colLayout('name') },
  { title: '业务类型', key: 'businessType', ...colLayout('type'), render(row) {
    return h('span', {}, businessTypeMap[row.businessType] || '其他')
  }},
  { title: '请求方式', key: 'requestMethod', ...colLayout('type') },
  { title: '操作人员', key: 'operName', ...colLayout('name') },
  { title: 'IP地址', key: 'operIp', ...colLayout('slug') },
