<template>
  <div class="system-workspace page-container page-container--scroll">
    <header class="admin-page-heading">
      <div><p class="admin-page-heading__kicker">CACHE OBSERVABILITY</p><h1>缓存监控</h1><span class="admin-page-heading__description">观察缓存容量、吞吐、命中率和连接状态。</span></div>
    </header>
    <!-- 统计图表 -->
    ...
    <n-card title="缓存键列表" style="margin-top: 16px">
      ...
      <n-data-table v-bind="tableListProps(cacheScroll)" :columns="columns" :data="keys" :loading="keysLoading" :row-key="(row: string) => row" />
    </n-card>
