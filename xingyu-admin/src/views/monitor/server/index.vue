<template>
  <div class="system-workspace page-container page-container--scroll">
    <header class="admin-page-heading">
      <div><p class="admin-page-heading__kicker">RUNTIME HEALTH</p><h1>服务器状态</h1><span class="admin-page-heading__description">查看 CPU、内存、JVM、磁盘与实时运行趋势。</span></div>
    </header>
    ...
    <n-card title="磁盘信息" style="margin-top: 16px">
      <n-data-table v-bind="tableListProps(diskScroll)" :columns="diskColumns" :data="serverInfo.disks || []" :row-key="(row: any) => row.path" />
    </n-card>
...
const diskColumns: DataTableColumns<any> = [
  { title: '盘符路径', key: 'path', ...colLayout('slug') },
