<template>
  <div class="profile-page page-container page-container--scroll">
    <header class="profile-heading">
      <div>
        <p>ACCOUNT CENTER</p>
        <h1>个人资料</h1>
        <span>管理你的运营身份和联系方式。</span>
      </div>
      <n-tag v-if="loading" type="info" size="small">正在同步</n-tag>
    </header>
      ...
      <div class="profile-left">
        ...
        <n-card class="user-card" :bordered="false">
          <div class="avatar-section">
            <button class="avatar-wrapper" type="button" aria-label="更换头像" :disabled="loading" @click="triggerUpload">
              <n-avatar
                round
                :size="100"
...
:global(body.dark-theme) .profile-heading h1 {
  color: rgba(255, 255, 255, .9);
}

:global(body.dark-theme) .profile-heading span {
