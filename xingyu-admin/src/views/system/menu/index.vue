<template>
  <div class="system-workspace page-container">
    <header class="admin-page-heading">
      <div><p class="admin-page-heading__kicker">NAVIGATION CONTROL</p><h1>菜单管理</h1><span class="admin-page-heading__description">维护后台导航、路由入口和按钮权限标识。</span></div>
    </header>
...
const columns: DataTableColumns<SysMenu> = [
  { title: '菜单名称', key: 'name', ...colLayout('title') },
  {
    title: '类型',
    key: 'type',
    ...colLayout('type'),
  ...
  { title: '路由地址', key: 'path', ...colLayout('slug'), render(row) {
      return row.path || '-'
    }},
  { title: '组件路径', key: 'component', ...colLayout('description'), render(row) {
      return row.component || '-'
    }},
  { title: '权限标识', key: 'permission', ...colLayout('slug'), render(row) {
