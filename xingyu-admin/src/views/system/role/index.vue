<template>
  <div class="system-workspace page-container">
    <header class="admin-page-heading">
      <div><p class="admin-page-heading__kicker">AUTHORIZATION</p><h1>角色权限</h1><span class="admin-page-heading__description">配置后台角色、菜单权限与数据访问范围。</span></div>
    </header>
...
const columns: DataTableColumns<SysRole> = [
  ...
  { title: '角色名称', key: 'name', ...colLayout('name') },
  { title: '角色编码', key: 'code', ...colLayout('slug') },
