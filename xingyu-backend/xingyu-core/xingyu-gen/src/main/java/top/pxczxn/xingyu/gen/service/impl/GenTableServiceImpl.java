package top.pxczxn.xingyu.gen.service.impl;
...
import top.pxczxn.xingyu.gen.entity.*;
import top.pxczxn.xingyu.gen.mapper.GenTableColumnMapper;
import top.pxczxn.xingyu.gen.mapper.GenTableMapper;
import top.pxczxn.xingyu.system.mapper.SysMenuMapper;
import top.pxczxn.xingyu.system.entity.SysRole;
import top.pxczxn.xingyu.system.entity.SysRoleMenu;
import top.pxczxn.xingyu.system.mapper.SysRoleMapper;
import top.pxczxn.xingyu.system.mapper.SysRoleMenuMapper;
import top.pxczxn.xingyu.gen.service.GenTableService;
...
public class GenTableServiceImpl implements GenTableService {
    ...
    public void importTable(String[] tableNames) {
        for (String tableName : tableNames) {
            ...
            table.setPackageName("top.pxczxn.xingyu.system");
    ...
    public List<String> previewGenerateFiles(Long tableId) {
        ...
        if (projectRoot.endsWith("xingyu-community-api")) {
            projectRoot = projectRoot.substring(0, projectRoot.length() - 20);
        }
    ...
    private String getProjectFilePath(GenTable table, String fileName, String projectRoot) {
        ...
        return switch (fileName) {
            case "Entity.java" -> projectRoot + "/xingyu-core/xingyu-system/src/main/java/top/pxczxn/xingyu/system/entity/" + className + ".java";
            case "Mapper.java" -> projectRoot + "/xingyu-core/xingyu-system/src/main/java/top/pxczxn/xingyu/system/mapper/" + className + "Mapper.java";
            case "Service.java" -> projectRoot + "/xingyu-core/xingyu-system/src/main/java/top/pxczxn/xingyu/system/service/" + className + "Service.java";
            case "ServiceImpl.java" -> projectRoot + "/xingyu-core/xingyu-system/src/main/java/top/pxczxn/xingyu/system/service/impl/" + className + "ServiceImpl.java";
            case "Controller.java" -> projectRoot + "/xingyu-api/xingyu-admin-api/src/main/java/top/pxczxn/xingyu/admin/controller/system/" + className + "Controller.java";
            case "api.ts" -> projectRoot + "/../xingyu-admin/src/api/" + businessName + ".ts";
            case "index.vue" -> projectRoot + "/../xingyu-admin/src/views/" + moduleName + "/" + businessName + "/index.vue";
