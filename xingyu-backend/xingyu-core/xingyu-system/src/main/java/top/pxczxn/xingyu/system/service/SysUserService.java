...
public interface SysUserService extends IService<SysUser> {
     ...
     * 分页查询用户
     */
    PageResult<SysUser> page(Integer page, Integer pageSize, String username, String email, String phone, Integer status, String userType, Long deptId, Long postId);
