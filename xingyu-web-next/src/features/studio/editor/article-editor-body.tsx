...
import { ArticleEditorMarkdownBody } from "./article-editor-markdown-body";
import { ArticleEditorMilkdownBody } from "./article-editor-milkdown-body";
import type {
  ArticleEditorBodyController,
  EditorCaretAnchor,
  EditorLinkDraft,
} from "@/lib/article-editor-body-controller";
import { ArticleEditorLinkPortal } from "./article-editor-link-portal";
...
/*
 * Migrated from Legacy components/studio/article-editor-body.tsx.
 * Adaptation: CSS module / cn import paths + local sibling imports for the
 * toolbar, link portal and the two body implementations. Controller wiring,
 * mode switching and markup are 1:1.
 */
