...
import type { EditorLinkDraft, EditorLinkPayload } from "@/lib/article-editor-body-controller";
import { isLinkUrlEmpty } from "@/lib/article-editor-link-url";

/*
 * Migrated from Legacy components/studio/article-editor-link-popover.tsx.
 * Adaptations:
 *   1. CSS module / cn import paths.
 *   2. `styles.linkPopoverActions-main` -> `styles["linkPopoverActions-main"]`.
 *      In JS the Legacy form parses as `styles.linkPopoverActions - main`, which
 *      is a bare-identifier reference; V2 gates the build with `tsc --noEmit`,
 *      so the bracket form is required. It resolves the exact same CSS-module
 *      class name, so runtime markup is identical.
 */
