...
export default function MeEmptyPage() {
  return (
    <CompactPageShell eyebrow="个人中心" title="个人中心还是空的" description="从一个小动作开始，慢慢建立属于你的星语轨迹" width="md">
      <section className={cn(pageStyles.orbitBg, "rounded-[24px] border border-white/80 bg-white/72 p-5 shadow-[0_16px_40px_rgba(30,45,82,.07)] backdrop-blur-xl sm:p-6")}>
