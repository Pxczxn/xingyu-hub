...
export default function TopicsPage() {
  ...
  return (
    <AppShell>
      <main data-layout="topics" className="mx-auto w-[calc(100%_-_2rem)] max-w-[1464px] pb-8 pt-4">
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_354px]">
          <section className="relative min-h-[390px] overflow-hidden">
            ...
            <div className={cn(styles.orbits, "absolute", "inset-x-5", "bottom-1", "top-24")}>
          ...
          <aside className={cn(panelStyles.sourcePanel, "min-h-[398px] p-4")}>
        ...
        <section className={cn(panelStyles.sourcePanel, "mt-4 grid overflow-hidden lg:grid-cols-4")}>
        ...
        <section id="topic-ranking" className={cn(panelStyles.sourcePanel, styles.risingPanel, "mt-6")}>
