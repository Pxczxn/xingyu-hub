...
export const SCREEN_REGISTRY: ScreenSpec[] = [
  ...screens("PUB", "web", [
    ...
    ["系列详情", "/series/{seriesId}"], ["系列阅读", "/series/{seriesId}/read"], ["个人主页", "/u/{username}"],
  ...
  ...screens("USR", "web", [
    ...
    ["我的星系", "/me/galaxies"], ["我的群聊", "/me/groups"],     ["创作数据", "/studio/analytics"],
    ["公开资料编辑", "/settings/profile"], ["成长记录", "/me/growth"], ["个人关系请求", "/me/requests"], ["个人空状态", "/me/empty"],
  ]),
  ...screens("CRT", "web", [
    ["创作工作台", "/studio"], ["内容管理总览", "/studio/content"], ["创作设置", "/studio/settings"],
    ["文章编辑器", "/studio/content/{articleId}"], ["版本历史", "/studio/content/{articleId}/versions"], ["系列管理", "/studio/series"],
  ...
  ...screens("SET", "web", [
    ...
    ["设备与会话", "/settings/security/sessions"], ["安全事件", "/settings/security/events"],
    ["数据概览", "/settings/data"], ["数据导出", "/settings/data/export"], ["注销账号", "/settings/data/delete-account"],
    ["通用偏好", "/settings/preferences"], ["外观主题", "/settings/appearance"], ["屏蔽管理", "/settings/blocks"],
    ["搜索历史", "/settings/search-history"], ["重新验证", "/settings/security/re-authenticate"],
  ]),
  ...screens("GOV", "web", [
...
if (SCREEN_TOTAL !== 152 || COMPONENT_TOTAL !== 36) {
