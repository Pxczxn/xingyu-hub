...
export const REDIRECT_RULES: RedirectRule[] = [
  ...
  { from: "/notifications", to: "/", permanent: true },
  { from: "/notifications/archive", to: "/", permanent: true },
  ...
  { from: "/studio/content/new", to: "/studio/content", permanent: true },
  { from: "/studio/content/:articleId/edit", to: "/studio/content/:articleId", permanent: true },
  { from: "/studio/content/:articleId/preview", to: "/studio/content/:articleId?action=preview", permanent: true },
  { from: "/studio/content/:articleId/publish", to: "/studio/content/:articleId?action=publish", permanent: true },
  { from: "/studio/content/:articleId/submit", to: "/studio/content/:articleId?action=submit", permanent: true },
  { from: "/studio/content/:articleId/conflict", to: "/studio/content/:articleId?action=conflict", permanent: true },
  { from: "/studio/content/:articleId/recovery", to: "/studio/content/:articleId?action=recovery", permanent: true },
  { from: "/studio/content/:articleId/review", to: "/studio/content/:articleId?action=review", permanent: true },
  { from: "/messages/direct/:conversationId", to: "/messages/:conversationId", permanent: true },
  { from: "/messages", to: "/?openMessages=1", permanent: false },
  { from: "/messages/u/:username", to: "/u/:username?dm=1", permanent: false },
